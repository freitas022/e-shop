create table tb_category (category_id bigint generated by default as identity, name varchar(255), primary key (category_id));
create table tb_order (order_status smallint check (order_status between 0 and 4), client_id bigint, id bigint generated by default as identity, moment timestamp(6) with time zone, primary key (id));
...
create table tb_product (price numeric(38,2), product_id bigint generated by default as identity, description varchar(255), img_url varchar(255), name varchar(255), primary key (product_id));
...
create table tb_role (role_id bigint generated by default as identity, authority varchar(255), primary key (role_id));
create table tb_user (user_id bigint generated by default as identity, email varchar(255), name varchar(255), password varchar(255), phone varchar(255), primary key (user_id));
